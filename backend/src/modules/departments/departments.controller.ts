...
export class DepartmentsController {
  ...
  @Get() @RequirePermissions('departments:view') @ApiOperation({ summary: 'List departments' })
  findAll(@CurrentUser('tenantId') tenantId: string) { return this.svc.findAll(tenantId); }

  @Get(':id') @RequirePermissions('departments:view') @ApiOperation({ summary: 'Get department' })
  findOne(@CurrentUser('tenantId') tenantId: string, @Param('id') id: string) { return this.svc.findOne(tenantId, id); }

  @Post() @RequirePermissions('departments:create') @ApiOperation({ summary: 'Create department' })
  ...
  @Put(':id') @RequirePermissions('departments:edit_all') @ApiOperation({ summary: 'Update department' })
  ...
  @Delete(':id') @RequirePermissions('departments:delete') @ApiOperation({ summary: 'Delete department' })
